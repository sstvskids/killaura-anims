...
runFunction(function()
	...
	local anims = {
		...
		SkidWare = {
			{CFrame = CFrame.new(0.69, -0.7, 0.6) * CFrame.Angles(math.rad(-80), math.rad(76), math.rad(-90)), Time = 0.1},
			{CFrame = CFrame.new(0.7, -0.71, 0.59) * CFrame.Angles(math.rad(-80), math.rad(76), math.rad(-38)), Time = 0.2}
		},
		Sudicial = {
