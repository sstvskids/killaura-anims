...
runFunction(function()
	...
	local anims = {
		...
		SkidWare = {
			{CFrame = CFrame.new(0.69, -0.7, 0.6) * CFrame.Angles(math.rad(-65), math.rad(65), math.rad(-90)), Time = 0.1},
			{CFrame = CFrame.new(0.7, -0.71, 0.59) * CFrame.Angles(math.rad(-98), math.rad(35), math.rad(-38)), Time = 0.2}
		},
		Moonsoon = {
		...
		Spooky = {
			{CFrame = CFrame.new(0.69, -0.7, 0.6) * CFrame.Angles(math.rad(-32), math.rad(54), math.rad(-56)), Time = 0.08},
			{CFrame = CFrame.new(0.7, -0.71, 0.59) * CFrame.Angles(math.rad(-10), math.rad(38), math.rad(-23)), Time = 0.15}
		},
	}
    ...
    killauraanimmethod = Killaura.CreateDropdown({
        Name = "Animation", 
	List = {"Normal", "Slow", "New", "Fast", "Exhibition", "SkidWare", "Moonsoon", "Spooky"},
        Function = function(val) end
    })
	local oldviewmodel
	local oldraise
